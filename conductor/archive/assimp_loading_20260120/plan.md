...
## Phase 2: 材质与纹理自动化处理 [checkpoint: 215bff4]
...
- [x] Task: Conductor - 用户手册验证 'Phase 2: 材质与纹理自动化处理' (Protocol in workflow.md)

## Phase 3: RHI 转换与场景集成
- [x] Task: 实现 Assimp Mesh 到 RHI 缓冲区的转换
    - [x] 处理索引转换和顶点数据打包 (src/Core/AssetLoader.cpp)
    - [x] 封装为 `std::vector<FRenderable>`
- [x] Task: 演示场景集成
    - [x] 更新 `main.cpp`，允许通过 UI 加载外部模型
    - [x] 验证模型渲染效果
- [x] Task: Conductor - 用户手册验证 'Phase 3: RHI 转换与场景集成' (Protocol in workflow.md)
