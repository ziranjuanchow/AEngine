...
## Phase 3: IBL 环境预处理与集成 [checkpoint: 45be2ec]
...
- [x] Task: Conductor - 用户手册验证 'Phase 3: IBL 环境预处理与集成' (Protocol in workflow.md)

## Phase 4: 整合与场景演示
- [~] Task: 构建 PBR 测试场景
    - [ ] 创建一个包含球体矩阵的测试场景 (不同粗糙度/金属度)
    - [ ] 添加一个方向光
- [x] Task: 集成到 AEngine 主循环
    - [x] 连接 SceneNode -> RenderGraph -> RHI (main.cpp)
- [x] Task: Conductor - 用户手册验证 'Phase 4: 整合与场景演示' (Protocol in workflow.md)
